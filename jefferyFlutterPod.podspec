...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of jefferyFlutterPod.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mynameissujie/jefferyFlutterPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mynameissujie' => '379675320@qq.com' }
  ...
  # s.resource_bundles = {
  #   'jefferyFlutterPod' => ['jefferyFlutterPod/Assets/*.png']
  # }
